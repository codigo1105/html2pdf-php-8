...
<table id="tabla-cabecera">
  <tr>
    ...
    <td class="v45">
        <h3>TECNOLOGÍA Y SERVICIOS R&S E.I.R.L.</h3>
        <label class="direccion">CAL. TACNA NRO. 3336 URB. SAN MIGUEL LIMA - LIMA - SANMIGUEL</label>

    </td>
    <td class="v30" style="text-align: left">
        <div class="ruc-emisor v100">
            <h4>R.U.C. 20621584960</h4>
...
<table id="tabla-cliente">
    ...
    <tr>
        ...
        <td class="v80" colspan="3">TECHMULTISERV S.A</td>
